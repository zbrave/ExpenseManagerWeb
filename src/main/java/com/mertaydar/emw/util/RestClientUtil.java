package com.mertaydar.emw.util;
...
public class RestClientUtil {
	...
	private static final String URI = "ExpenseManager";
 /*   private HttpHeaders getHeaders() {
	...
	String url = "http://localhost:8080/"+URI+"/user/article/{id}";
    ...
    public void getAllArticlesDemo() {
    	HttpHeaders headers = getHeaders();  
        RestTemplate restTemplate = new RestTemplate();
	String url = "http://localhost:8080/"+URI+"/user/articles";
        HttpEntity<String> requestEntity = new HttpEntity<String>(headers);
    ...
    public void addArticleDemo() {
    	HttpHeaders headers = getHeaders();  
        RestTemplate restTemplate = new RestTemplate();
	String url = "http://localhost:8080/"+URI+"/user/article";
